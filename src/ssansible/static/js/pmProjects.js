...
pmProjects.model.page_item = {
    ...
    buttons:[
        ...
        },
        {
            ...
            link:function(item_id){ return ssansible.opt.host +'/?project/'+ item_id + '/playbook/run'},
            help:'Run playbook'
        },
        {
            class:'btn btn-info',
            ...
            link:function(item_id){ return ssansible.opt.host +'/?project/'+ item_id + '/ansible-module/run'},
            help:'Run module'
        },
        {
            class:'btn btn-info',
            ...
            link:function(item_id){ return ssansible.opt.host +'/?project/'+ item_id + '/periodic-tasks'},
            help:'Periodic tasks'
        },
        {
            class:'btn btn-info',
            ...
            link:function(item_id){ return ssansible.opt.host +'/?project/'+ item_id + '/history'},
            help:'history'
        },
        {
...
pmProjects.syncRepo = function(item_id)
{
    return spajs.ajax.Call({
        ...
        error:function(e)
        {
            ...
            ssansible.showErrors(e.responseJSON)
        }
    });
}
...
tabSignal.connect("ssansible.start", function()
{
    // projects
    spajs.addMenu({
        id:"projects",
