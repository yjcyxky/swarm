...
CREATE TABLE IF NOT EXISTS `nagios_acknowledgements` (
  ...
  `entry_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `entry_time_usec` int(11) NOT NULL default '0',
  `acknowledgement_type` smallint(6) NOT NULL default '0',
  `object_id` int(11) NOT NULL default '0',
  `state` smallint(6) NOT NULL default '0',
  `author_name` varchar(64) character set utf8mb4 NOT NULL default '',
  `comment_data` varchar(255) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_commands` (
  ...
  `object_id` int(11) NOT NULL default '0',
  `command_line` varchar(255) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_commenthistory` (
  ...
  `object_id` int(11) NOT NULL default '0',
  `comment_time` datetime NOT NULL default '1990-01-01 00:00:00',
  ...
  `expiration_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `deletion_time` datetime NOT NULL default '1990-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `nagios_configfiles` (
  ...
  `configfile_path` varchar(255) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_configfilevariables` (
  ...
  `varname` varchar(64) character set utf8mb4 NOT NULL default '',
  `varvalue` varchar(255) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_conninfo` (
  ...
  `instance_id` smallint(6) NOT NULL default '0',
  `agent_name` varchar(32) character set utf8mb4 NOT NULL default '',
  `agent_version` varchar(8) character set utf8mb4 NOT NULL default '',
  `disposition` varchar(16) character set utf8mb4 NOT NULL default '',
  `connect_source` varchar(16) character set utf8mb4 NOT NULL default '',
  `connect_type` varchar(16) character set utf8mb4 NOT NULL default '',
  `connect_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `disconnect_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `last_checkin_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `data_start_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `data_end_time` datetime NOT NULL default '1990-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `nagios_contactgroups` (
  ...
  `alias` varchar(255) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_contactnotificationmethods` (
  ...
  `command_args` varchar(255) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_contacts` (
  ...
  `config_type` smallint(6) NOT NULL default '0',
  `contact_object_id` int(11) NOT NULL default '0',
  `alias` varchar(64) character set utf8mb4 NOT NULL default '',
  `email_address` varchar(255) character set utf8mb4 NOT NULL default '',
  `pager_address` varchar(64) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_contactstatus` (
  ...
  `instance_id` smallint(6) NOT NULL default '0',
  `contact_object_id` int(11) NOT NULL default '0',
  `status_update_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `host_notifications_enabled` smallint(6) NOT NULL default '0',
  `service_notifications_enabled` smallint(6) NOT NULL default '0',
  `last_host_notification` datetime NOT NULL default '1990-01-01 00:00:00',
  `last_service_notification` datetime NOT NULL default '1990-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `nagios_customvariables` (
  ...
  `varname` varchar(255) character set utf8mb4 NOT NULL default '',
  `varvalue` varchar(255) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_dbversion` (
  ...
  `version` varchar(10) character set utf8mb4 NOT NULL default ''
) ENGINE=MyISAM;
...
CREATE TABLE IF NOT EXISTS `nagios_downtimehistory` (
  ...
  `scheduled_start_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `scheduled_end_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `was_started` smallint(6) NOT NULL default '0',
  `actual_start_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `actual_start_time_usec` int(11) NOT NULL default '0',
  `actual_end_time` datetime NOT NULL default '1990-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `nagios_eventhandlers` (
  ...
  `output` varchar(255) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_externalcommands` (
  ...
  `command_name` varchar(128) character set utf8mb4 NOT NULL default '',
  `command_args` varchar(255) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_flappinghistory` (
  ...
  `instance_id` smallint(6) NOT NULL default '0',
  `event_time` datetime NOT NULL default '1990-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `nagios_hostchecks` (
  ...
  `output` varchar(255) character set utf8mb4 NOT NULL default '',
  `long_output` TEXT NOT NULL default '',
  `perfdata` TEXT character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_hosts` (
  ...
  `address` varchar(128) character set utf8mb4 NOT NULL default '',
  `importance` int(11) NOT NULL default '0',
  `check_command_object_id` int(11) NOT NULL default '0',
  `check_command_args` varchar(255) character set utf8mb4 NOT NULL default '',
  `eventhandler_command_object_id` int(11) NOT NULL default '0',
  `eventhandler_command_args` varchar(255) character set utf8mb4 NOT NULL default '',
  `notification_timeperiod_object_id` int(11) NOT NULL default '0',
  `check_timeperiod_object_id` int(11) NOT NULL default '0',
  `failure_prediction_options` varchar(64) character set utf8mb4 NOT NULL default '',
  ...
  `notes` varchar(255) character set utf8mb4 NOT NULL default '',
  `notes_url` varchar(255) character set utf8mb4 NOT NULL default '',
  `action_url` varchar(255) character set utf8mb4 NOT NULL default '',
  `icon_image` varchar(255) character set utf8mb4 NOT NULL default '',
  `icon_image_alt` varchar(255) character set utf8mb4 NOT NULL default '',
  `vrml_image` varchar(255) character set utf8mb4 NOT NULL default '',
  `statusmap_image` varchar(255) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_hoststatus` (
  ...
  `current_check_attempt` smallint(6) NOT NULL default '0',
  `max_check_attempts` smallint(6) NOT NULL default '0',
  `last_check` datetime NOT NULL default '1990-01-01 00:00:00',
  `next_check` datetime NOT NULL default '1990-01-01 00:00:00',
  `check_type` smallint(6) NOT NULL default '0',
  `last_state_change` datetime NOT NULL default '1990-01-01 00:00:00',
  `last_hard_state_change` datetime NOT NULL default '1990-01-01 00:00:00',
  `last_hard_state` smallint(6) NOT NULL default '0',
  `last_time_up` datetime NOT NULL default '1990-01-01 00:00:00',
  `last_time_down` datetime NOT NULL default '1990-01-01 00:00:00',
  `last_time_unreachable` datetime NOT NULL default '1990-01-01 00:00:00',
  `state_type` smallint(6) NOT NULL default '0',
  `last_notification` datetime NOT NULL default '1990-01-01 00:00:00',
  `next_notification` datetime NOT NULL default '1990-01-01 00:00:00',
  ...
  `obsess_over_host` smallint(6) NOT NULL default '0',
  `modified_host_attributes` int(11) NOT NULL default '0',
  `event_handler` varchar(255) character set utf8mb4 NOT NULL default '',
  `check_command` varchar(255) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_instances` (
  ...
  `instance_name` varchar(64) character set utf8mb4 NOT NULL default '',
  `instance_description` varchar(128) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_logentries` (
  ...
  `logentry_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `entry_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `entry_time_usec` int(11) NOT NULL default '0',
  `logentry_type` int(11) NOT NULL default '0',
  `logentry_data` varchar(255) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_objects` (
  ...
  `name1` varchar(128) character set utf8mb4 NOT NULL default '',
  `name2` varchar(128) character set utf8mb4 default NULL,
...
CREATE TABLE IF NOT EXISTS `nagios_processevents` (
  ...
  `program_name` varchar(16) character set utf8mb4 NOT NULL default '',
  `program_version` varchar(20) character set utf8mb4 NOT NULL default '',
  `program_date` varchar(10) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_programstatus` (
  ...
  `instance_id` smallint(6) NOT NULL default '0',
  `status_update_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `program_start_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `program_end_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `is_currently_running` smallint(6) NOT NULL default '0',
  `process_id` int(11) NOT NULL default '0',
  `daemon_mode` smallint(6) NOT NULL default '0',
  `last_command_check` datetime NOT NULL default '1990-01-01 00:00:00',
  `last_log_rotation` datetime NOT NULL default '1990-01-01 00:00:00',
  `notifications_enabled` smallint(6) NOT NULL default '0',
  ...
  `modified_host_attributes` int(11) NOT NULL default '0',
  `modified_service_attributes` int(11) NOT NULL default '0',
  `global_host_event_handler` varchar(255) character set utf8mb4 NOT NULL default '',
  `global_service_event_handler` varchar(255) character set utf8mb4 NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `nagios_servicestatus` (
  ...
  `last_hard_state_change` datetime NOT NULL default '1990-01-01 00:00:00',
  `last_hard_state` smallint(6) NOT NULL default '0',
  `last_time_ok` datetime NOT NULL default '1990-01-01 00:00:00',
  `last_time_warning` datetime NOT NULL default '1990-01-01 00:00:00',
  `last_time_unknown` datetime NOT NULL default '1990-01-01 00:00:00',
  `last_time_critical` datetime NOT NULL default '1990-01-01 00:00:00',
  `state_type` smallint(6) NOT NULL default '0',
  `last_notification` datetime NOT NULL default '1990-01-01 00:00:00',
  `next_notification` datetime NOT NULL default '1990-01-01 00:00:00',
  `no_more_notifications` smallint(6) NOT NULL default '0',
...
CREATE TABLE IF NOT EXISTS `nagios_statehistory` (
  ...
  `instance_id` smallint(6) NOT NULL default '0',
  `state_time` datetime NOT NULL default '1990-01-01 00:00:00',
...
CREATE TABLE IF NOT EXISTS `nagios_timedeventqueue` (
  ...
  `instance_id` smallint(6) NOT NULL default '0',
  `event_type` smallint(6) NOT NULL default '0',
  `queued_time` datetime NOT NULL default '1990-01-01 00:00:00',
  `queued_time_usec` int(11) NOT NULL default '0',
  `scheduled_time` datetime NOT NULL default '1990-01-01 00:00:00',
