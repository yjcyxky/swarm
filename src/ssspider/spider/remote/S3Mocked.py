...
# intra-module
from spider.remote.S3 import RemoteObject as S3RemoteObject, RemoteProvider as S3RemoteProvider
from spider.remote.S3 import S3Helper
from spider.decorators import dec_all_methods
...
def pickled_moto_wrapper(func):
    """
        ...
        for follow-on tasks. Since spider may execute with multiple threads
