...
from spider.remote import AbstractRemoteObject, AbstractRemoteProvider
from spider.exceptions import WorkflowError
from spider.common import lazy_property
    ...
    def upload(self):
        try:
            ...
            raise WorkflowError(e,
                ...
                "via gcloud (see Spider documentation). When running in a "
                "kubernetes cluster, make sure that storage-rw is added to "
                "--scopes (see Spider documentation).")
