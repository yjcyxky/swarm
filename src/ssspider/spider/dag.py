...
from spider.io import IOFile, _IOFile, PeriodicityDetector, wait_for_files, is_flagged, contains_wildcard
from spider.jobs import Job, Reason
from spider.exceptions import RuleException, MissingInputException
from spider.exceptions import MissingRuleException, AmbiguousRuleException
from spider.exceptions import CyclicGraphException, MissingOutputException
from spider.exceptions import IncompleteFilesException
from spider.exceptions import PeriodicWildcardError, WildcardError
from spider.exceptions import RemoteFileException, WorkflowError
from spider.exceptions import UnexpectedOutputException, InputFunctionException
from spider.logging import logger
from spider.output_index import OutputIndex
from spider.common import DYNAMIC_FILL
from spider import conda
...
class DAG:
    ...
    def archive(self, path):
        ...
        Archiving includes git versioned files (i.e. spiderfiles, config files, ...),
        ...
        try:
            ...
            with tarfile.open(path, mode=mode, dereference=True) as archive:
                ...
                logger.info("Archiving spiderfiles, scripts and files under "
                            "version control...")
