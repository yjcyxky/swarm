...
from spider.io import IOFile, _IOFile, protected, temp, dynamic, Namedlist, AnnotatedString, contains_wildcard_constraints, update_wildcard_constraints
from spider.io import expand, InputFiles, OutputFiles, Wildcards, Params, Log, Resources
from spider.io import apply_wildcards, is_flagged, not_iterable, is_callable
from spider.exceptions import RuleException, IOFileException, WildcardError, InputFunctionException, WorkflowError
from spider.logging import logger
from spider.common import Mode


class Rule:
    def __init__(self, *args, lineno=None, spiderfile=None,
                 restart_times=0):
        """
        Create a rule
        ...
        if len(args) == 2:
            ...
            self.spiderfile = other.spiderfile
