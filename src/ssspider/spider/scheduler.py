...
from spider.executors import DryrunExecutor, TouchExecutor, CPUExecutor
from spider.executors import (
...
class JobScheduler:
    ...
    def _error(self, job):
        ...
        If Spider is configured to restart jobs then the job might have
