"""
Django settings for ssdeploy project.
...
WSGI_APPLICATION = 'ssdeploy.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'ssdeploy', 'static')
